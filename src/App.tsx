...
function App() {
  const { summary, skills } = profileData
            ...
            <div id="about" className="space-y-6">
              ...
              <div className="flex flex-wrap gap-2">
                {skills.map((skill, index) => (
                  <span key={index} className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-primary/10 text-primary rounded-full text-xs font-medium">
              ...
              <div className="pt-2">
                <a
                  href="https://drive.google.com/uc?export=download&id=14bhW7jvSXiXccNxp4BlP6SbPcAf_YSSp"
                  target="_blank"
